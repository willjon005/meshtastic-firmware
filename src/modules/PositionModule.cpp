...
int32_t PositionModule::runOnce()
{
    ...
    uint32_t now = millis();
    uint32_t intervalMs = (config.position.position_broadcast_secs * 1000); // CHANGED FROM: Default::getConfiguredOrDefaultMsScaled(config.position.position_broadcast_secs,
                                                                            //                                                       default_broadcast_interval_secs, numOnlineNodes)                                                              default_broadcast_interval_secs, numOnlineNodes);
